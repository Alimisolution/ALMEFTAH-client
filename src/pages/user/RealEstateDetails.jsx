...
import PropertyBasedLocationCard from "../../components/user/home/PropertyBasedLocationCard";
...
const RealEstateDetails = () => {
  ...
  return (
    <div className="md:px-[80px] px-[8px] mt-[20px]">
      <div className="mb-[30px]">
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center gap-[20px]">
            <span className="w-[58px] h-[58px] border-2 border-[#000]/[0.2] bg-white rounded-full flex items-center justify-center">
      ...
      <div className="flex gap-[30px] mb-[20px] flex-wrap md:flex-nowrap">
        <div className="p-[10px] bg-white rounded-2xl w-[100%] md:w-[60%]">
          <img
            src={houseImg1}
            alt=""
        ...
        <div className="bg-white rounded-2xl p-5 w-[100%] md:w-[40%]">
          ...
          <div className="flex items-center justify-between gap-[27px] mt-[10px] flex-wrap">
      ...
      <div className="grid grid-cols-2 gap-[30px] mb-[20px]">
        <div className="p-[20px] bg-white rounded-2xl col-span-2 md:col-span-1">
          <h2 className="text-[20px] text-[#000929] font-[700] leading-[22px] tracking-[-0.2px] pb-[17px] border-b border-[#F9C379] mb-[20px]">
            Features
          </h2>
      ...
      <div className="p-[20px] bg-white rounded-2xl mb-[44px]">
        <h2 className="text-[20px] text-[#000929] font-[700] leading-[22px] tracking-[-0.2px] pb-[17px] border-b border-[#F9C379] mb-[10px]">
          Address
        </h2>
      ...
      <section>
        <div className="flex justify-between items-center mb-[29px]">
          <h2 className="text-[20px] text-[#000929] font-[700] leading-[22px] tracking-[-0.2px]">
            Like properties
          </h2>
          <div className="text-[#1EAFCA] text-[18px] font-[500] leading-[26px] tracking-[0.5px] flex items-center gap-[8px]">
            Learn More
            <span className="shadow-[0px_0px_20px_0px_#69b99d94]">
              <ChevronRightCircleIcon color="#1EAFCA" />
            </span>
          </div>
        </div>
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-[30px] mb-[50px]">
