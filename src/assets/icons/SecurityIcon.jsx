const SecurityIcon = () => {
  return (
    ...
    >
      ...
      />
      <path
        d="M19.6338 16C17.951 18.8033 15.1069 20.6217 13.406 21.5194C12.7989 21.8398 12.4954 22 12 22C11.5046 22 11.2011 21.8398 10.594 21.5194C8.89304 20.6217 6.049 18.8033 4.36619 16M20.9999 8C20.9986 6.54505 20.9763 5.7889 20.5959 5.28529C20.1918 4.75029 19.2781 4.49056 17.4507 3.9711C16.2022 3.6162 15.1016 3.18863 14.2223 2.79829C13.0234 2.2661 12.424 2 12 2C11.576 2 10.9766 2.2661 9.77769 2.79829C8.89837 3.18863 7.79782 3.61619 6.54931 3.9711C4.72191 4.49056 3.8082 4.75029 3.40409 5.28529C3.02369 5.7889 3.00137 6.54505 3.00006 8"
        stroke="#0A62CC"
        strokeWidth="1.5"
        strokeLinecap="round"
      />
