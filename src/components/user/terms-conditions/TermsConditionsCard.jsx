import img from "../../../assets/images/terms-conditions/img.png";

const TermsConditionsCard = () => {
  return (
    <section className="grid grid-cols-6 gap-[50px] mb-[56px]">
      <div className="col-span-6 lg:col-span-3">
        <h2 className="text-[32px] text-[#000] font-[700] leading-[38.4px] mb-[68px]">
        ...
        <p className="text-[20px] text-[#73788C] font-[400] leading-[36px]  tracking-[0.05px] text-with-ellipsis">
          Last Revised: December 16, 2024 Welcome to www.lorem-ipsum.info. This
