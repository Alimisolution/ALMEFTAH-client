...
const FilterCard = () => {
  ...
  return (
    <section className="bg-white px-[15px] py-[30px] rounded-[16px] border-[1.5px] border-[#C6CED4]">
      ...
      <Input
        ...
        onChange=""
      />
      <div className="flex justify-between mt-[20px] mb-[8px] h-[64px] pb-[10px] border-b border-[#E2E8F0]">
      ...
      <div className="pb-[20px] mb-[20px] border-b border-[#E2E8F0]">
        ...
        <div className="w-full flex flex-col items-center space-y-4">
          ...
          <ReactSlider
            ...
            max={1000000}
            value={range}
            onChange={(value) => setRange(value)} // Update state with the new value
          />
      ...
      <div className="pb-[20px] mb-[20px] border-b border-[#E2E8F0]">
        ...
        <div className="flex gap-[20px] items-center flex-wrap mb-[20px] pb-[20px] mb-[20px] border-b border-[#E2E8F0]">
