import privacyImg from "../../../assets/images/dashboard/privacy.png";

const CompanyPrivacyCard = () => {
  return (
    <div className="">
      <div className="flex justify-between items-center gap-[5px] border-b-2 border-b-[#E0E4EC]">
        <div>
          ...
          <h2 className="text-[30px] text-[#1F2744] font-[600] leading-[74px] tracking-[0.075px]">
            Your information is protected on our platform{" "}
          </h2>
        </div>
...
export default CompanyPrivacyCard;
