...
const CompanyFilterModal = ({ openFilterModal, setOpenFilterModal }) => {
              ...
              >
                {({ setFieldValue, values }) => (
                  <Form>
                    ...
                    <label className="text-[#000] text-[16px] font-[400] mb-[14px] block w-full">
                    Property type
                    </label>
                      <Select
                        className="bg-white"
  ...
  className="w-[20px] h-[20px] bg-[#7F7F7F]"
/>
