...
import Select from "../../common/Select"; // Import your custom Select component
              ...
              >
                {() => (
                  <Form>
                        ...
                        <Field
                          ...
                          render={({ field, form }) => (
                            <Select
                              ...
                              error={form.errors.subscriptionStatus}
                              className="bg-[#fff] w-full placeholder:text-[#808080B] text-[#808080] text-[14px] placeholder:font-[300] font-[400] focus:outline-none rounded-2xl border-2 border-[#C4D9F2] h-[57px] px-[20px] py-[18px] pr-[40px]"
                            />
                          )}
                        />
                    ...
                    <div className="flex justify-center items-center gap-[20px] mb-[15px] pt-[20px] border-t border-[#E2E8F0]">
                      <Button
                        text="Show results"
                        variant="primary"
                        type="submit"
