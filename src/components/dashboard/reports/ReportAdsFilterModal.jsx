...
const ReportAdsFilterModal = ({ reportAdsFilterModal, setReportAdsFilterModal }) => {
                  ...
                  <Form>
                    ...
                    <div className="flex items-center gap-[20px] mb-[15px]">
                      ...
                      <Button
                        ...
                        variant="secondary"
                        type="button"
                        onClick={() => setReportAdsFilterModal(false)}
                      />
                    </div>
                  </Form>
                )}
...
export default ReportAdsFilterModal;
